...
const NETWORKS = [
  ...
  },
  {
    ...
    chainId: 11155111,
    status: 'live',
    rpcUrl: process.env.ETHEREUM_SEPOLIA_RPC_URL || process.env.SEPOLIA_RPC_URL || 'https://ethereum-sepolia-rpc.publicnode.com',
    marketplace: '0x6d132Ba2327573c4e6f97a2167dCddb8059C4d14',
    paymentGateway: '0x1A880Ae46993282dd77C2dDCc5e36498eB616C92',
    feeManager: '0x51aB383A43d79f4127B7E7dCBcd892164FA2838F',
  ...
  },
  {
    ...
    expectedGovernance: {
      ...
      timelockMinDelaySeconds: '0',
      openExecutor: false,
      note: 'Avalanche Fuji is EOA-operated through a zero-delay timelock for testnet only.',
    },
  },
  {
    ...
    chainId: 4801,
    status: 'live',
    rpcUrl: process.env.WORLDCHAIN_SEPOLIA_RPC_URL || 'https://worldchain-sepolia.g.alchemy.com/public',
    marketplace: '0x6d132Ba2327573c4e6f97a2167dCddb8059C4d14',
    paymentGateway: '0x1A880Ae46993282dd77C2dDCc5e36498eB616C92',
    feeManager: '0x51aB383A43d79f4127B7E7dCBcd892164FA2838F',
    ...
    expectedGovernance: {
      ...
      timelockMinDelaySeconds: '0',
      openExecutor: false,
      note: 'World Chain Sepolia is EOA-operated through a zero-delay timelock for testnet only. The stale first M2M pair is intentionally not referenced.',
    },
  },
];
