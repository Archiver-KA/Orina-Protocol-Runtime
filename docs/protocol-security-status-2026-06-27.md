...
- Current BSC Testnet and Base Sepolia deployments were reconciled against Foundry broadcast artifacts and spot-checked on-chain for bytecode and M2M Marketplace wiring.
...
- M2M `DelegationManager.DEFAULT_ADMIN_ROLE` remains with deployment/admin EOA `0x282Be18838D7079C215F49749a9606d77e00888b` on both testnets; production requires handoff to timelock/governance.
