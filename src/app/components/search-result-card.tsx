...
const NETWORK_LOGO_PATHS: Record<string, string> = {
  ...
  'optimism-sepolia': '/network-logos/optimism.svg',
  'op-sepolia': '/network-logos/optimism.svg',
  ...
  'world-chain': '/network-logos/worldchain.svg',
  'worldchain-sepolia': '/network-logos/worldchain.svg',
  'world-sepolia': '/network-logos/worldchain.svg',
