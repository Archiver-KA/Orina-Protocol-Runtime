...
function ToggleSwitch({ checked, onChange }: ToggleSwitchProps) {
  return (
    <button
      onClick={onChange}
      className={`relative inline-flex h-4 w-8 items-center rounded-full cursor-pointer transition-colors flex-shrink-0 ${checked ? 'bg-[#2CC295]' : 'bg-zinc-700'
        }`}
    >
      <span
  ...
  return (
    <section className="h-full bg-ui-page overflow-hidden">
      ...
      <div className="flex-1 min-w-0 p-2.5 pr-0 overflow-hidden">
            ...
            <div className="space-y-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-[rgba(255,255,255,0.02)] border-0 rounded-lg px-4 py-2.5 text-white focus:ring-[#2CC295]/20 focus:border-[#2CC295] text-sm placeholder:text-zinc-600"
              ...
              <div className="bg-zinc-900/30 border border-red-900/30 rounded-xl p-6">
                ...
                <div className="flex items-center justify-between p-4 bg-blue-900/5 rounded-lg border border-blue-900/20 mb-4">
                  ...
                  <button
                    ...
                    className="px-4 py-2 bg-[rgba(255,255,255,0.05)] hover:bg-[rgba(255,255,255,0.08)] text-[#F1F5F9] text-xs font-bold rounded-full transition-colors"
                  >
                    Inspect Data
                  </button>
                </div>
                ...
                <div className="flex items-center justify-between p-4 bg-red-900/5 rounded-lg border border-red-900/20">
                  ...
                  <button
                    ...
                    className="px-4 py-2 bg-[rgba(255,255,255,0.05)] hover:bg-red-500/15 text-red-300 text-xs font-bold rounded-full transition-colors"
                  >
                    Reset Profile
                  </button>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-[rgba(255,255,255,0.02)] border-0 rounded-xl p-6">
                  ...
                  <button className="inline-flex items-center gap-2 px-4 py-2 text-xs font-bold bg-[rgba(255,255,255,0.05)] hover:bg-red-500/15 rounded-full text-zinc-300 hover:text-red-300 transition-colors">
                    <Trash2 size={14} />
                    Delete Permanently
                  </button>
                </div>
        ...
        {/* Footer Save Bar */}
        <div className="absolute bottom-0 left-0 right-0 p-6 bg-[rgba(18,18,18,0.95)] backdrop-blur-xl border-t border-[var(--t-border-subtle)] z-20">
          <div className="max-w-5xl mx-auto flex items-center justify-between">
            ...
            <div className="flex gap-4">
              <button
                className="px-6 py-2.5 rounded-full text-sm font-bold text-zinc-400 hover:text-white transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
      ...
      <StudioSidebarShell widthClassName="w-[344px]" className="bg-ui-page border-l-0 p-2.5">
        ...
        {/* Header */}
        <div className="p-6 border-b border-[var(--t-border-subtle)] bg-gradient-to-b from-white/[0.02] to-transparent">
        ...
        <div className="flex-grow overflow-y-auto p-5 space-y-8 custom-scrollbar">
          ...
          {/* Quick Security */}
          <div className="p-5 bg-[rgba(255,255,255,0.02)] border-0 backdrop-blur-[10px] rounded-2xl">
        ...
        {/* Footer Button */}
        <div className="mt-auto border-t border-[var(--t-border-subtle)] p-5 bg-zinc-950/80 backdrop-blur-md">
          <button className="w-full py-3 bg-[rgba(255,255,255,0.02)] border-0 rounded-xl text-xs font-bold text-white hover:border-red-500/50 hover:text-red-400 transition-all flex items-center justify-center gap-2 group">
