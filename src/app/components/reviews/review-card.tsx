        ...
        <div className="min-w-0 space-y-2">
          <div className="flex flex-wrap items-center gap-2">
            ...
            {review.verifiedPurchase && (
              <span className="rounded-full border border-[#2CC295]/35 bg-[#2CC295]/10 px-2 py-0.5 text-[10px] font-bold uppercase tracking-[0.08em] text-[#2CC295]">
                Verified
              </span>
            )}
          ...
          {isOwner ? (
            <>
              <button
                ...
                className="rounded-lg border border-zinc-800 px-3 py-1.5 text-xs font-bold text-zinc-200 transition-colors hover:border-zinc-700 hover:bg-zinc-900"
              >
                Edit
              </button>
              <button
                ...
                className="rounded-lg border border-red-500/20 px-3 py-1.5 text-xs font-bold text-red-300 transition-colors hover:border-red-500/35 hover:bg-red-500/10"
              >
                Delete
              </button>
            </>
            ...
            <button
              ...
              className="rounded-lg border border-zinc-800 px-3 py-1.5 text-xs font-bold text-zinc-300 transition-colors hover:border-zinc-700 hover:bg-zinc-900"
            >
              Report
            </button>
          )}
