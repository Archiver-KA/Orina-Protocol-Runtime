  ...
  return (
    ...
    >
      <div className="h-full p-2.5">
        <div className={`surface-primary-shell h-full rounded-[var(--t-card-radius-lg)] flex flex-col overflow-hidden ${collapsed ? 'pt-5 pb-2.5 px-2.5' : 'p-[var(--t-shell-sidebar-section-p)]'}`}>
