...
export function ProfileFollowButton({
  ...
  return (
    <button
      className={cn(
        'inline-flex h-[25px] min-w-[73px] items-center justify-center rounded-full border px-4 text-[12px] font-bold leading-none transition-colors backdrop-blur-md',
        following
