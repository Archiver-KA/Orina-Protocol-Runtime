...
const WORLDCHAIN_SEPOLIA_FAUCET = '0xbbD53C18F4d9fb98AA6c4837ea0E8F221e1b5F0F';
const WORLDCHAIN_SEPOLIA_USDT_T = '0x11E6c8f2806b32dAC427E7Df07F67602647eF87A';
const WORLDCHAIN_SEPOLIA_USDC_T = '0xD6E84789741Ea2DE727961cCB383454E4A845035';
...
export const TESTNET_STARTER_KITS: Record<number, TestnetStarterKitConfig> = {
  ...
  [CHAIN_CONFIG.WORLDCHAIN_SEPOLIA_CHAIN_ID]: {
    enabled: runtimeFlags.enableTestnetStarterKit,
    chainId: CHAIN_CONFIG.WORLDCHAIN_SEPOLIA_CHAIN_ID,
    networkKey: 'worldchain-sepolia',
    networkLabel: 'World Chain Sepolia',
    shortLabel: 'World Sepolia',
    nativeTokenLabel: 'ETH',
    gasFaucetUrl: runtimeConfig.worldchainSepoliaGasFaucetUrl,
    faucetAddress: normalizeAddress(runtimeConfig.worldchainSepoliaTokenFaucetAddress || WORLDCHAIN_SEPOLIA_FAUCET),
    tokens: {
      USDT: {
        label: 'USDT.t',
        address: normalizeAddress(runtimeConfig.worldchainSepoliaUsdtAddress || WORLDCHAIN_SEPOLIA_USDT_T),
        decimals: 6,
      },
      USDC: {
        label: 'USDC.t',
        address: normalizeAddress(runtimeConfig.worldchainSepoliaUsdcAddress || WORLDCHAIN_SEPOLIA_USDC_T),
        decimals: 6,
      },
    },
  },
