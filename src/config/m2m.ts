...
export const M2M_CONTRACTS_BY_CHAIN_ID = {
  ...
  43113: {
    DELEGATION_MANAGER: parseOptionalAddress(
      env.VITE_AVALANCHE_FUJI_M2M_DELEGATION_MANAGER || AVALANCHE_FUJI_CONTRACTS.DELEGATION_MANAGER,
    ),
    AI_WALLET_FACTORY_V2: parseOptionalAddress(
      env.VITE_AVALANCHE_FUJI_M2M_AI_WALLET_FACTORY_V2 || AVALANCHE_FUJI_CONTRACTS.AI_WALLET_FACTORY_V2,
    ),
  },
  4801: {
    DELEGATION_MANAGER: parseOptionalAddress(
      env.VITE_WORLDCHAIN_SEPOLIA_M2M_DELEGATION_MANAGER || WORLDCHAIN_SEPOLIA_CONTRACTS.DELEGATION_MANAGER,
    ),
    AI_WALLET_FACTORY_V2: parseOptionalAddress(
      env.VITE_WORLDCHAIN_SEPOLIA_M2M_AI_WALLET_FACTORY_V2 || WORLDCHAIN_SEPOLIA_CONTRACTS.AI_WALLET_FACTORY_V2,
    ),
  },
} as const;
