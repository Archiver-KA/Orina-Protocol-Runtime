...
3. `READ gitnexus://repo/ATP2/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/ATP2/context` | Codebase overview, check index freshness |
| `gitnexus://repo/ATP2/clusters` | All functional areas |
| `gitnexus://repo/ATP2/processes` | All execution flows |
| `gitnexus://repo/ATP2/process/{name}` | Step-by-step execution trace |
